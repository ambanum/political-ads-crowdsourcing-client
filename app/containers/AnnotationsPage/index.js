...
export function AnnotationsPage({ annotations, error, load, loading, match }) {
  ...
  return (
    <React.Fragment>
        ...
        <Container>
          ...
          <div className="buttons">
            <Button
              renderAs="a"
              color="success"
              href="/political-ads/annotations/nothing-suspect"
            >
              nothing-suspect
            </Button>
            <Button
              renderAs="a"
              color="primary"
              href="/political-ads/annotations/cant-say"
            >
              cant-say
            </Button>
            <Button
              renderAs="a"
              color="primary"
              href="/political-ads/annotations/not-related-to-politics"
            >
            ...
            <Button
              renderAs="a"
              color="danger"
              href="/political-ads/annotations/survey"
            >
              Survey
            </Button>
            <Button
              renderAs="a"
              color="danger"
              href="/political-ads/annotations/promotes-candidates"
            >
              promotes-candidates
            </Button>
            <Button
              renderAs="a"
              color="danger"
              href="/political-ads/annotations/new-controversial-element"
            >
      ...
      <Section>
        <Container>
          {annotations && (
            <Tag color="dark" size="medium">Total displayed {annotations.results.length}</Tag>
          )}
          {loading && <Spinner />}
          {!loading && annotations && (
            <AdsCollection>
